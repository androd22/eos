...
final class UserControllerTest extends WebTestCase
{
    ...
    public function testShow(): void
    {
        ...
        $fixture->setIsKycVerified('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $fixture->setIsKycVerified('Value');
        ...
        $this->client->submitForm('Update', [
            ...
            'user[isKycVerified]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getIsKycVerified());
